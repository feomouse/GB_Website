        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductName = table.Column<string>(type: "nvarchar(20)", nullable: true),
                    ProductType = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_shopMerchant", x => new { x.MerchantId, x.ShopId });
                    table.ForeignKey(
                        name: "FK_shopMerchant_shop_ShopId",
                        column: x => x.ShopId,
                        principalSchema: "shop",
                        principalTable: "shop",
                        principalColumn: "PkId",
